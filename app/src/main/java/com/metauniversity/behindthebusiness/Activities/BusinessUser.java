...
public class BusinessUser extends ParseObject {
    ...
    public ParseUser getUser() { return getParseUser(KEY_BUSINESS_USER); }
    ...
    public String getSocialFB() { return getString(KEY_SocialFb); }
    public void setSocialFB(String social) { put(KEY_SocialFb, social); }
    ...
    public boolean getOnline() {return getBoolean(KEY_ONLINE); }
    public void setOnline(boolean isOnline) { put(KEY_ONLINE, isOnline); }

    public ParseFile getProfileImage() { return getParseFile(KEY_PROFILEPIC); }
    public void setProfileImage(ParseFile profilePic) { put(KEY_PROFILEPIC, profilePic); }
}
