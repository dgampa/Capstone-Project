...
@Parcel(analyze = IndividualPost.class)
public class IndividualPost extends ParseObject {
    // private instance variables for different fields of post
    public static final String KEY_IMAGE = "image";
    public static final String KEY_USER = "individual";
    ...
    public void setImage(ParseFile imageFile){ put(KEY_IMAGE, imageFile); }
    ...
    public ParseUser getBusiness() { return getParseUser(KEY_BUSINESS); }
    public void setBusiness(ParseUser business) { put(KEY_BUSINESS, business); }
}
